...
class _PatientsScreenState extends State<PatientsScreen> {
  ...
  String _s(dynamic val) => (val is String)
      ? val
  ...
  void _confirmDelete(Map p) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text(l10n.t('deletePatientTitle'),
  ...
  void _showAddDialog(AppLocalizations l10n, bool isRtl) {
    final dossierCtrl = TextEditingController(
        text: MedicalFileNumberSuggest.suggestNext(patients));
    ...
    final motifCtrl =
        TextEditingController(text: l10n.t('defaultConsultationReason'));
    String sexe = 'H';
              ...
              child: SingleChildScrollView(
                child: Column(
                    ...
                    children: [
                      ...
                      _sectionHeader(
                          l10n.t('essentialInfo'), Icons.person_add_rounded),
                      ...
                      const SizedBox(height: 24),
                      _sectionHeader(l10n.t('contactIdentity'),
                          Icons.contact_phone_rounded),
                      const SizedBox(height: 20),
                      Row(children: [
                        Expanded(
                            child: _field(l10n.t('medicalFileNumber'),
                                dossierCtrl, Icons.folder_shared_rounded,
                                hintText: l10n.t('fileNumHint'))),
                        const SizedBox(width: 16),
                        Expanded(
                            child: _field(l10n.t('nationalId'), cinCtrl,
                                Icons.badge_rounded)),
                      ]),
                      const SizedBox(height: 16),
                      _field(l10n.t('reason'), motifCtrl, Icons.notes,
                          hintText: l10n.t('exampleConsultation')),
                      const SizedBox(height: 16),
                      Row(children: [
                        Expanded(
                            child: _field(
                                l10n.t('phone'), phoneCtrl, Icons.phone_rounded,
                      ...
                      const SizedBox(height: 16),
                      _dropdown(
                          l10n.t('socialCoverage'),
                          couverture,
                          ["Sans", "AMO", "RAMED", "CNOPS", "Privé"],
                          (v) => setDialogState(() => couverture = v!)),
  ...
  void _showScheduleFromPatient(int id, String name, String dossier,
    ...
    final motifCtrl = TextEditingController(
        text: initialReason.isEmpty
            ? loc.t('defaultConsultationReason')
            : initialReason);
              ...
              InkWell(
                ...
                child: Container(
                    ...
                    child: Row(children: [
                      ...
                      Text(intl.DateFormat('dd/MM/yyyy').format(selectedDate))
                    ])),
              ),
              ...
              InkWell(
                onTap: () async {
                  final time = await showTimePicker(
                      context: schedCtx, initialTime: selectedTime);
  ...
  void _showEditDialog(Map p, AppLocalizations l10n, bool isRtl) {
    ...
    final dossierCtrl =
        TextEditingController(text: _s(p['medical_file_number']));
              ...
              builder: (_, setDialogState) => SingleChildScrollView(
                child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 24),
                      _sectionHeader(
                          l10n.t('personalInfo'), Icons.person_rounded),
                      const SizedBox(height: 20),
                      Row(children: [
                        Expanded(
                            child: _field("${l10n.t('lastName')} (*)", nomCtrl,
  ...
  Widget _buildAppBar(AppLocalizations l10n) => Container(
        ...
        child: Row(children: [
          ...
          ElevatedButton.icon(
            onPressed: () =>
                _showAddDialog(l10n, context.read<LanguageProvider>().isArabic),
            icon: const Icon(Icons.add, size: 20),
            label: Text(l10n.t('newPatientAction'),
            ...
            child: filtered.isEmpty
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) =>
                        _buildPatientRow(_paginated[index], index, l10n, isRtl),
                  ),
          ),
          ...
          child: GestureDetector(
            ...
            child: Row(children: [
              CircleAvatar(
                  ...
                  child: Text(_s(p['name'])[0].toUpperCase(),
        ...
        Expanded(
          ...
          child: Row(children: [
            IconButton(
                ...
                onPressed: () => _showEditDialog(p, l10n, isRtl)),
            IconButton(
  ...
  Widget _buildPaginationControls(AppLocalizations l10n) => Container(
      padding: const EdgeInsets.all(12),
      decoration: const BoxDecoration(
      ...
      child: Row(children: [
        Text(
            l10n.t('pageOf',
                args: {'page': '$_currentPage', 'total': '$_totalPages'}),
            style: GoogleFonts.dmSans(
                fontSize: 13,
                color: AppColors.textSecond,
  ...
  Widget _th(String text) => Text(text.toUpperCase(),
      style: GoogleFonts.dmSans(
          fontSize: 11,
