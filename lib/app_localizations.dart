...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _translations = {
    ...
    'viewCalendar':       {'fr': 'Voir le Calendrier ',   'ar': 'عرض تقويم المواعيد'},
    'calendarSubtitle':   {'fr': 'Gérer les rendez-vous','ar': 'إدارة المواعيد'},
    'recentActivity':     {'fr': 'Activité récente',     'ar': 'النشاط الأخير'},
    'noRecords':          {'fr': 'Aucun dossier médical','ar': 'لا tu n\'as pas de dossiers médicaux'},
    ...
    'email':              {'fr': 'Email',                'ar': 'البرide الإلكتروني'},
    ...
    'noInfoYet':          {'fr': 'Aucune information renseignée', 'ar': 'لا tu n\'as pas d\'informations'},
    ...
    'secretaryCode':      {'fr': 'Code Secrétaire',      'ar': 'رمز السكرتيرة'},
    ...
    'noMeasure':          {'fr': 'Aucune mesure disponible', 'ar': 'لا tu n\'as pas de mesures'},
    ...
    'noRecordFound':      {'fr': 'Aucun dossier médical','ar': 'لا tu n\'as pas de dossiers médicaux'},
    'createFirst':        {'fr': 'Créer le premier dossier', 'ar': 'إنشاء أول ملف'},
    'editRecord':         {'fr': 'Modifier le dossier',  'ar': 'تعدil الملف'},
    ...
    'noInvoices':         {'fr': 'Aucune facture trouvée','ar': 'لا tu n\'as pas de factures'},
